...
function showAbout() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: '<strong>Metaverse recources 🚀</strong>',
        
        html: `
        <br/>
        <div id="about">
            <b>Click the button below for more</b> metaverse recources
            <a href="https://github.com/miroslavpejic85/mirotalk" target="_blank"><br/></br>
            <img alt="mirotalk github" src="https://i.postimg.cc/zftxyYY8/neme.png"></a><br/><br/>
            <button class="far fa-heart pulsate" onclick="window.open('https://squid-game.glitch.me/')"> Go metaverse</button>
            <br /><br />
            Author:<a href="https://devpost.com/shannonchan17" target="_blank"> Shannon Chan</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
